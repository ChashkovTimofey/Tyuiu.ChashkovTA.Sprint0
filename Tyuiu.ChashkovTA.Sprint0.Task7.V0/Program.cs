...
using Tyuiu.ChashkovTA.Sprint0.Task7.V0.Lib;

using Tyuiu.ChashkovTA.Sprint0.Task7.V0.Lib;

namespace Tyuiu.ChashkovTA.Sprint0.Task7.V0
{
    internal class Program
    {
        static void Main(string[] args)
        {
            Console.Title = "Спринт #0 | Выполнил: Чашков Т. А.| ИИПБ-24-1";
            Console.WriteLine("***************************************************************************");
            ...
            Console.WriteLine("* одинаковыйх массивов по длинне.                                         *");
            Console.WriteLine("*                                                                         *");
            Console.WriteLine("***************************************************************************");
